...
namespace SC_Scripts.Scripts
{
    public partial class Scripts
    {
        ...
        public static void BackgroundClicking(ScriptsUtilities su)
        {
            while (true)
            {
                su.Sleep(40);
        ...
        public static void Mining(ScriptsUtilities su)
        {
            Data data = DataProvider.Get();

            su.BackgorundWindow = ScriptsUtilities.GetForegroundWindow(); //Sets backgorund window
        ...
        private static void BugCurrentWindow(ScriptsUtilities su)
        {

            ScriptsUtilities.ShowWindow(Process.GetCurrentProcess().MainWindowHandle, 6); //Minimalize Clicker
            ScriptsUtilities.SwitchToThisWindow(Process.GetCurrentProcess().MainWindowHandle, true); //Swicth to Clicker
            su.Sleep(100);
            ScriptsUtilities.LockSetForegroundWindow(1);
            ScriptsUtilities.SetForegroundWindow(su.BackgorundWindow); //Set BP in lock foreground to Clicker     
        }

        private static void DropSlot(ScriptsUtilities su, Keys slot, Keys dropBind)
        {
            su.SendKey(slot);
            su.Sleep(120);
            su.SendKey(dropBind);
        ...
        private static void DropSlots(ScriptsUtilities su, Data data)
        {
